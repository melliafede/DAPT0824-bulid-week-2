...
VALUES
('ST1542', 10001, 1, 'A1X3Y9', 2, 2.99, 'Credit Card'),
('ST1542', 10001, 2, 'G5M9X2', 3, 1.19, 'Credit Card'),
('ST1542', 10001, 3, 'L7Z2W8', 1, 15.99, 'Credit Card'),
('ST1542', 10001, 4, 'P9T3V6', 4, 0.50, 'Credit Card'),
('ST1542', 10001, 5, 'Z9C1L4', 2, 2.99, 'Credit Card');

-- Store ST2584
INSERT INTO SALES (StoreID, SalesID, LineID, ProductID, Quantity, UnitPrice, PaymentMethod)
VALUES
('ST2584', 10002, 1, 'B7Z2W5', 3, 1.89, 'Debit Card'),
('ST2584', 10002, 2, 'H8N2Y4', 2, 0.99, 'Debit Card'),
('ST2584', 10002, 3, 'M3K6N1', 2, 9.49, 'Debit Card'),
('ST2584', 10002, 4, 'E8P9Q4', 1, 3.99, 'Debit Card'),
('ST2584', 10002, 5, 'S7H3P9', 1, 2.29, 'Debit Card');

-- Store ST8574
INSERT INTO SALES (StoreID, SalesID, LineID, ProductID, Quantity, UnitPrice, PaymentMethod)
VALUES
('ST8574', 10003, 1, 'D3L7M2', 1, 2.79, 'Cash'),
('ST8574', 10003, 2, 'F4R7L8', 2, 1.99, 'Cash'),
('ST8574', 10003, 3, 'L3K6N1', 3, 3.49, 'Cash'),
('ST8574', 10003, 4, 'O4R8L2', 1, 19.99, 'Cash'),
('ST8574', 10003, 5, 'R2J8V6', 4, 1.79, 'Cash');

-- Store ST1584
INSERT INTO SALES (StoreID, SalesID, LineID, ProductID, Quantity, UnitPrice, PaymentMethod)
VALUES
('ST1584', 10004, 1, 'A3K9M4', 5, 1.79, 'Online'),
('ST1584', 10004, 2, 'I3P7T6', 2, 2.49, 'Online'),
('ST1584', 10004, 3, 'X2A7P5', 3, 1.29, 'Online'),
('ST1584', 10004, 4, 'F1K4T7', 2, 1.29, 'Online'),
('ST1584', 10004, 5, 'T1G5X7', 1, 0.55, 'Online');

-- Store ST1526
INSERT INTO SALES (StoreID, SalesID, LineID, ProductID, Quantity, UnitPrice, PaymentMethod)
VALUES
('ST1526', 10005, 1, 'V6E9K1', 1, 3.49, 'Credit Card'),
('ST1526', 10005, 2, 'Q4R8L2', 2, 2.49, 'Credit Card'),
('ST1526', 10005, 3, 'N4R8L19', 5, 0.99, 'Credit Card'),
('ST1526', 10005, 4, 'S7H3P9', 3, 2.29, 'Credit Card'),
('ST1526', 10005, 5, 'L7Z2W8', 1, 15.99, 'Credit Card');

-- Store ST7251
INSERT INTO SALES (StoreID, SalesID, LineID, ProductID, Quantity, UnitPrice, PaymentMethod)
VALUES
('ST7251', 10006, 1, 'J9X1L3', 2, 2.99, 'Debit Card'),
('ST7251', 10006, 2, 'K7Z2W8', 1, 4.99, 'Debit Card'),
('ST7251', 10006, 3, 'D2J8V6', 3, 2.49, 'Debit Card'),
('ST7251', 10006, 4, 'N5P2Q9', 2, 6.99, 'Debit Card'),
('ST7251', 10006, 5, 'Y5B3M8', 1, 3.79, 'Debit Card');

-- Store ST9024
INSERT INTO SALES (StoreID, SalesID, LineID, ProductID, Quantity, UnitPrice, PaymentMethod)
VALUES
('ST9024', 10007, 1, 'N4R8L12', 3, 2.50, 'Cash'),
('ST9024', 10007, 2, 'W3D7T2', 4, 1.49, 'Cash'),
('ST9024', 10007, 3, 'M5P2Q9', 1, 4.49, 'Cash'),
('ST9024', 10007, 4, 'C2X5Y8', 2, 3.49, 'Cash'),
('ST9024', 10007, 5, 'S7H3P9', 1, 2.29, 'Cash');

-- Store ST4433
INSERT INTO SALES (StoreID, SalesID, LineID, ProductID, Quantity, UnitPrice, PaymentMethod)
VALUES
('ST4433', 10008, 1, 'I8M4T2', 3, 1.79, 'Online'),
('ST4433', 10008, 2, 'O4R8L2', 1, 19.99, 'Online'),
('ST4433', 10008, 3, 'A3K9M4', 5, 1.79, 'Online'),
('ST4433', 10008, 4, 'K1X9Y5', 2, 7.99, 'Online'),
('ST4433', 10008, 5, 'P9T3V6', 2, 0.50, 'Online');

-- Store ST9800
INSERT INTO SALES (StoreID, SalesID, LineID, ProductID, Quantity, UnitPrice, PaymentMethod)
VALUES
('ST9800', 10009, 1, 'F4R7L8', 4, 1.99, 'Cash'),
('ST9800', 10009, 2, 'X2A7P5', 3, 1.29, 'Cash'),
('ST9800', 10009, 3, 'V6E9K1', 2, 3.49, 'Cash'),
('ST9800', 10009, 4, 'D3L7M2', 1, 2.79, 'Cash'),
('ST9800', 10009, 5, 'P9T3V6', 2, 0.50, 'Cash');

-- Store ST3931
INSERT INTO SALES (StoreID, SalesID, LineID, ProductID, Quantity, UnitPrice, PaymentMethod)
VALUES
('ST3931', 10010, 1, 'I3P7T6', 2, 2.49, 'Credit Card'),
('ST3931', 10010, 2, 'Z9C1L4', 3, 2.99, 'Credit Card'),
('ST3931', 10010, 3, 'H8N2Y4', 1, 0.99, 'Credit Card'),
('ST3931', 10010, 4, 'M3K6N1', 4, 9.49, 'Credit Card'),
('ST3931', 10010, 5, 'S7H3P9', 1, 2.29, 'Credit Card');

-- Store ST4121
INSERT INTO SALES (StoreID, SalesID, LineID, ProductID, Quantity, UnitPrice, PaymentMethod)
VALUES
('ST4121', 10011, 1, 'A1X3Y9', 2, 2.99, 'Debit Card'),
('ST4121', 10011, 2, 'G5M9X2', 1, 1.19, 'Debit Card'),
('ST4121', 10011, 3, 'N4R8L16', 2, 4.99, 'Debit Card'),
('ST4121', 10011, 4, 'I8M4T2', 3, 1.79, 'Debit Card'),
('ST4121', 10011, 5, 'N4R8L18', 2, 1.59, 'Debit Card');
